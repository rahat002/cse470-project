...
public class PromoCode extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter PromoCode");
        ...
        jButton2.setBackground(new java.awt.Color(54, 172, 143));
...
try {
    Scanner sc = new Scanner(file);
        ...
        JOptionPane.showMessageDialog(null,"PromoCode Entered Successefully","Hello Sir!",JOptionPane.INFORMATION_MESSAGE);
        this.setVisible(false);
        break;
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PromoCode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
