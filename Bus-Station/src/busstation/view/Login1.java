...
import busstation.controller.Admin;
import busstation.model.BusStation;
import busstation.model.Managers;
...
public class Login1 extends javax.swing.JFrame {
    ...
    String user;
    String pass;
    Managers x = new Managers("omar",4767);
    File record = new File("click.wav");
    File record1=new File ("Recording1.wav");
    ...
    private void initComponents() {
        ...
        jLabel3.setForeground(new java.awt.Color(54, 172, 143));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/busstation/view/images/unnamed.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(txt1, javax.swing.GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE)
                            .addComponent(txt2))
                        .addGap(36, 36, 36))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(114, 114, 114)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ((x.Username.equals(user)) && (x.Password.equals(pass))){
              JOptionPane.showMessageDialog(null,"Successfully Login ","Welcome admin",JOptionPane.INFORMATION_MESSAGE);
              Admin a = new Admin();
              a.setVisible(true);
              this.setVisible(false);
        }else {
              BusStation.playrecord(record1);
        }
