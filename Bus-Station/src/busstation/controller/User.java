...
package busstation.controller;

import busstation.model.BusStation;
import busstation.view.Exit;
...
import busstation.view.Welcome;
...
public class User extends javax.swing.JFrame  {
  ...
  public Passengers user1() throws FileNotFoundException
    ...
    private void initComponents() {
        ...
        combo1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Choose One", "Banani", "Gulshan", "Motijheel", "Dhanmodi", "Mirpur" }));
        ...
        combo2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Choose One", "Barishal", "Chitagong", "Sylhet", "Rajshahi" }));
    ...
    private void btn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn3ActionPerformed
        ...
        txt1.setText(String.valueOf(price)+" "+"TK");
        if (Normal.equals("normal")){
            txt2.setText("");
            txt3.setText("");
        }else if(Normal.equals("VIP")) {
            balance = p.balance;
            txt2.setText(String.valueOf(balance)+" "+"TK");
            after = balance - price;
            txt3.setText(String.valueOf(after)+" "+"TK");}
    ...
    private void combo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo1ActionPerformed
        ...
        switch (destination){
            case "Banani": distance = 20;  break;
            case "Gulshan": distance = 30;  break;
            case "Motijheel": distance = 35;  break;
            case "Dhanmodi": distance = 40; break;
            case "Mirpur": distance = 25; break;
    ...
    private void combo2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo2ActionPerformed
        ...
        switch (destination){
            ...
            case "Barishal": distance = 70; break;
            case "Chitagong": distance = 80; break;
            case "Sylhet": distance = 90; break;
            case "Rajshahi": distance = 100; break;
             }
